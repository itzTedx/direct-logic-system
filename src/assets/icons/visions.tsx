...
export const IconBulb = (props: SVGProps) => {
  return (
    <svg {...props} height="18" viewBox="0 0 18 18" width="18" xmlns="http://www.w3.org/2000/svg">
      <g fill="currentColor">
        ...
        />
        <path
          d="M3.16599 3.16599L3.87299 3.87299"
          fill="none"
          stroke="currentColor"
          strokeLinecap="round"
          strokeLinejoin="round"
        ...
        />
        <path
          d="M13.75 8.99999C13.75 6.04069 11.0445 3.71348 7.972 4.35818C6.0998 4.75108 4.62103 6.31669 4.31453 8.20489C3.93513 10.5427 5.26681 12.6193 7.25001 13.407V15.25C7.25001 16.0784 7.92161 16.75 8.75001 16.75H9.25001C10.0784 16.75 10.75 16.0784 10.75 15.25V13.407C12.505 12.71 13.75 11.004 13.75 8.99999Z"
          fill="none"
          stroke="currentColor"
          strokeLinecap="round"
          strokeLinejoin="round"
...
export const IconHandshake = (props: SVGProps) => {
  return (
    <svg {...props} height="18" viewBox="0 0 18 18" width="18" xmlns="http://www.w3.org/2000/svg">
      <g fill="currentColor">
        <line
...
export const IconStarSparkle = (props: SVGProps) => {
  return (
    <svg {...props} height="18" viewBox="0 0 18 18" width="18" xmlns="http://www.w3.org/2000/svg">
      <g fill="currentColor">
        <path
        ...
        <path
          ...
          strokeWidth="0"
        />
        <circle cx="14.25" cy="3.25" fill="currentColor" r=".75" strokeWidth="0" />
      </g>
    </svg>
  );
};

export const IconWorld = (props: SVGProps) => {
  return (
    <svg {...props} height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
      <g fill="currentColor">
...
export const IconChartUp = (props: SVGProps) => {
  return (
    <svg {...props} height="18" viewBox="0 0 18 18" width="18" xmlns="http://www.w3.org/2000/svg">
      <g fill="currentColor">
        <rect
