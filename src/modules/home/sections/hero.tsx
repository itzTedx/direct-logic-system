...
export const Hero = () => {
  return (
    <header className="overflow-hidden bg-gradient-to-b from-[#E5CAFF]/30 to-transparent" role="banner">
      ...
      <div className="relative z-10 ml-auto grid max-w-[85rem] grid-cols-1 items-center gap-4 pt-24 pl-4 md:pl-6 lg:grid-cols-2 lg:pt-24 lg:pl-8">
        <div className="">
          <Badge>
            <BadgeDot />
