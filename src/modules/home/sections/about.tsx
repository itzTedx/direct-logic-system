        ...
        <div className="grid gap-1 rounded-[calc(var(--radius-2xl)+var(--spacing)*1)] bg-accent p-1">
          <div className="grid grid-cols-3 gap-1">
            <div className="aspect-4/3 rounded-2xl bg-card p-6">
              <h3>Reliable Security Solutions</h3>
              <p>
                From firewalls to endpoint protection, we safeguard your business with cutting-edge cybersecurity
                measures.
              </p>
            </div>
            <div className="flex aspect-4/3 flex-col items-center justify-center rounded-2xl bg-card p-6">
              <div className="relative flex h-24 w-56 items-center">
                ...
                <span className="mx-auto block w-fit font-semibold text-5xl text-primary">24/7</span>
              </div>
              <h3 className="mt-6 text-center font-medium text-2xl">Dedicated Support Team</h3>
          ...
          <div className="grid grid-cols-12 gap-1">
            <div className="col-span-5 rounded-2xl bg-card">
              <SliderFeature />
            </div>
